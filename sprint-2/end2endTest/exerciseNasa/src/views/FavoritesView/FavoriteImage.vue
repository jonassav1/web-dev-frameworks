...
const { apod } = defineProps<{ apod: Apod }>();
</script>
...
.favorite-image .details {
  padding: 1rem;
}

.favorite-image .details .title {
...
.favorite-image .details .explanation {
  color: var(--color-text);
  font-size: 1rem;
  line-height: 1.5;
}
